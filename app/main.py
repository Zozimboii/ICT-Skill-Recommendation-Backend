...
# from backend.app.db.models import JobsSkill, JobCountBySubCategory, JobSkillCountBySkillname, JobSkillsWithCategories ,User
# from app.schemas import LoginRequest , RegisterRequest
# from backend.app.core.security import hash_password, verify_password
# from backend.app.db.models import JobsSkill, JobCountBySubCategory, JobSkillCountBySkillname, JobSkillsWithCategories
# from app.schemas_advisor import AdvisorRequest
# from backend.app.scrapers.jobsdb_scapper import fetch_jobsdb, summarize_job_title_trend
